...
if __name__ == "__main__":
    ...
    time_codify, memory_used_codify, dna_codified = measure_performance(
        dna_to_binary_and_save, dna, "binary/files/dna.bin"
    )
    binary_file_size = os.path.getsize("binary/files/dna.bin")

    time_decodify, memory_used_decodify, dna_decodified = measure_performance(
        binary_to_dna_and_save, dna_codified, len(dna), "binary/files/dna.txt"
    )
    dna_file_size = os.path.getsize("binary/files/dna.txt")
